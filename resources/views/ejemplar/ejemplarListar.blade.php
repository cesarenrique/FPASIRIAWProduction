            ...
            <div class="container-fluid py-4">
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Ejemplar</h6>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                          ...
                                          <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  <p class="text-lg font-weight-bold mb-0"><?php echo $fila['estanteria'] ?></p>
                                                </td>
                                                <td class="align-middle text-center ">
                                                  <p class="text-lg font-weight-bold mb-0"><?php echo $fila['localizacion'] ?></p>
                                                </td>
                                                <td class="align-middle text-center ">
                                                  <p class="text-lg font-weight-bold mb-0"><?php echo $fila['articulo'] ?></p>
                                                </td>
                ...
                <script>
                	function eliminar(id){
                		...
                		if (msg) {
                			window.location = "<?php echo url('/ejemplar/borrar')?>/"+id;
                		}
                  }
                </script>
